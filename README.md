...
- What happens when invalid data enters the system?
- What happens if business processes fail?
- What happens if multiple systems communicate incorrectly?
- What happens when reality doesn't follow the happy path?

I enjoy looking at software from both perspectives:

- 👨‍💻 Technical
- 👩‍💼 Business

Because software quality is created where technology and business meet.
...
🚀 Learning new technologies is one of my favorite hobbies.

---

# 🐞 My Philosophy

> **Quality isn't achieved by executing test cases.**

> It comes from understanding business processes, users, data, system interactions and asking the questions nobody else asked.
